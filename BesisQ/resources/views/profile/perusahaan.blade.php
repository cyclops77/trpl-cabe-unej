          ...
          <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
              ...
              <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
                <span class="name">{{$akun->nama_perusahaan}}</span>
                    ...
                    <form class="form-horizontal" method="get">
                      ...
                      <fieldset>
                        <div class="form-group">
                          <label class="col-md-3 control-label" for="profileFirstName">Nama Perusahaan</label>
                          <div class="col-md-8">
                            <input type="text" class="form-control" id="profileFirstName" value="{{$akun->nama_perusahaan}}">
                          </div>
                        </div>
                        <div class="form-group">
